...
var _fajar = __webpack_require__(27);

var _fajar2 = _interopRequireDefault(_fajar);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_reactDom2.default.render(_react2.default.createElement(_fajar2.default, null), document.getElementById('container')); /**
...
var AppComponent = function (_React$Component) {
    ...
    function AppComponent(props) {
        ...
        _this.state = {
            tasksArray: [{ title: 'shopping', description: 'buy soya milk' }]
        };
        return _this;
    }
    ...
    _createClass(AppComponent, [{
        ...
        value: function addTask(task) {
            this.setState(function (oldState) {
                var newTasks = oldState.tasksArray.slice(0);
                newTasks.push(task);
                return {
                    tasksArray: newTasks
                };
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_form2.default, { cb: this.addTask.bind(this) }),
                _react2.default.createElement(_list2.default, { tasks: this.state.tasksArray })
            );
        }
    }]);
...
var ListComponent = (_temp = _class = function (_React$Component) {
    ...
    _createClass(ListComponent, [{
         ...
         */
        value: function fromArrayTasksToLi() {
            ...
            try {
                for (var _iterator = tasks[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                    ...
                    arrayoflis.push(_react2.default.createElement(
                        'li',
                        null,
                        task.title
                    ));
        ...
        key: 'render',
        value: function render() {
            var tasksGrabbedFrom = this.props.tasks;
            return _react2.default.createElement(
                'ul',
                null,
    ...
    tasks: _propTypes2.default.array.isRequired }, _temp);
...
var FormComponent = (_temp = _class = function (_React$Component) {
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement('input', { type: 'text', name: 'title', ref: function ref(inputDomElement) {
                            _this2.titleInput = inputDomElement;
                        } })
                ),
                _react2.default.createElement(
                    'div',
                    ...
                    _react2.default.createElement('input', { type: 'text', name: 'description', ref: function ref(inputDomElement) {
                            _this2.descriptionInput = inputDomElement;
                        } })
                ),
                _react2.default.createElement(
                    'div',
