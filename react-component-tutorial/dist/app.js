...
_reactDom2.default.render(_react2.default.createElement(_helloWorld2.default, { message: 'hello from parent component' }), document.getElementById('container'));
...
var HelloWorldComponent = (_temp = _class = function (_React$Component) {
    ...
    function HelloWorldComponent(props) {
        ...
        _this.alertClicked = _this.alertClicked.bind(_this);
        _this.state = {
            isVisible: true,
            stams: []
        };
    ...
    _createClass(HelloWorldComponent, [{
        ...
        key: 'addTextToList',
        value: function addTextToList(event) {
            event.preventDefault();
            var stamString = this.stamInput.value;
            console.log('' + stamString);
            this.setState(function (oldState) {

                var newStams = oldState.stams.splice(0);
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'form',
                    { onSubmit: this.addTextToList.bind(this) },
                    _react2.default.createElement(
                        'label',
                        null,
                        'Enter Text:'
                    ),
                    _react2.default.createElement('input', { type: 'text', name: 'stam', ref: function ref(domElementInput) {
                            _this2.stamInput = domElementInput;
                        } }),
                    _react2.default.createElement('br', null),
                    _react2.default.createElement(
                        'button',
                ...
                _react2.default.createElement(
                    'ul',
                    null,
                    this.state.stams.map(function (stamText) {
                        return _react2.default.createElement(
                            'li',
                            null,
                            stamText
