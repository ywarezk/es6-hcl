...
var _baseGetTag = __webpack_require__(50);

var _baseGetTag2 = _interopRequireDefault(_baseGetTag);

var _getPrototype = __webpack_require__(55);
...
var TaskListComponent = (_dec = (0, _reactRedux.connect)(function (state) {
    var tasks = state.todo.tasks;
    return {
        todoListProp: tasks
    };
}, function (dispatch) {
    return {
        grabTasks: function grabTasks() {
            dispatch((0, _redux.grabTasksFromServer)());
        }
    };
    ...
    function TaskListComponent() {
        ...
        return _possibleConstructorReturn(this, (TaskListComponent.__proto__ || Object.getPrototypeOf(TaskListComponent)).apply(this, arguments));
    }
    ...
    _createClass(TaskListComponent, [{
        ...
        value: function render() {
            var tasks = this.props.todoListProp;
            var grabTasks = this.props.grabTasks;
    ...
    todoListProp: _propTypes2.default.array.isRequired,
    grabTasks: _propTypes2.default.func.isRequired
}, _temp)) || _class);
...
_reactDom2.default.render(_react2.default.createElement(
    ...
    { store: _redux.store },
    _react2.default.createElement(TaskListComponent, null)
...
var _getRawTag = __webpack_require__(53);

var _getRawTag2 = _interopRequireDefault(_getRawTag);

var _objectToString = __webpack_require__(54);
...
exports.store = exports.ADD_TASK = undefined;
exports.addTask = addTask;
exports.grabTasksFromServer = grabTasksFromServer;
...
function todoReducer() {
    ...
    switch (action.type) {
        case 'ADD_TASK':
            // const stateCopy = {...state, tasks: []};
            var newTasks = state.tasks.splice(0);
            newTasks.push(action.payload);
            return {
                tasks: newTasks
            };
